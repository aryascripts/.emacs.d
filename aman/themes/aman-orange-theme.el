...
;;; aman-orange-theme.el --- Emacs theme with a dark background.

;; Copyright (C) 2014 , Aman Bhimani
...
(provide-theme 'aman-orange)

;; Local Variables:
;; no-byte-compile: t
;; End:

;;; aman-orange-theme.el ends here